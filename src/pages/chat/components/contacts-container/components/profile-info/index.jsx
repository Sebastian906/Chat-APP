            ...
            <div className='flex gap-5'>
                <TooltipProvider>
                    <Tooltip>
                        ...
                        <TooltipContent className='bg-[#1c1b1e] border-none text-white'>Editar Perfil</TooltipContent>
                    </Tooltip>
                </TooltipProvider>
                ...
                <TooltipProvider>
                    <Tooltip>
                        ...
                        <TooltipContent className='bg-[#1c1b1e] border-none text-white'>Cerrar Sesión</TooltipContent>
                    </Tooltip>
                </TooltipProvider>
            </div>
        </div>
